...
<%
	...
	for(int i=0; i<list.size(); i++){
		...
		list.get(i).put("nickName", hash.get("member_nickname"));		
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide foot-slide">
                    <div class="foot_head">
                    	...
                    	<%
	                	String member_nickname = (String) list.get(i).get("nickName");
                        ...
                        <div class="foot_area_name"><%=list.get(i).get("nickName") %></div>
                    </div>
                    <div class="foot_like">
